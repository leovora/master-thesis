...
from scr.data.load_data import load_data_from_csv, preprocess_data
...
def get_predictions(tickers, start_date, end_date, sequence_length, folder_path="../models", data_folder="../data"):
    predictions = {}
    actuals = {}
